...
from showmeprompt.dialog_window import EditRawWindow, RenameWindow
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.current_image_file_Path = Path('./fake_file_path/fake_file.png')
        ...
        self._gallery_image_label_axis_tuple = ()
    ...
    def get_image_prompt(self, file_path: Path) -> ImagePromptInfo:
        ...
        """
        return self._prompt_cache_dict.get(file_path) or self.update_image_prompt(file_path)
    ...
    def update_image_prompt(self, file_path: Path) -> ImagePromptInfo:
        ...
        self._prompt_cache_dict[file_path] = image_prompt
        return image_prompt
    ...
    def file_rename(self, new_file_path: Path) -> None:
        ...
        # update self._prompt_cache_dict
        self._prompt_cache_dict[new_file_path] = self._prompt_cache_dict.pop(self.current_image_file_Path)
        # update self._gallery_image_label_dict
        image_label_data: list = self._gallery_image_label_dict.pop(self.current_image_file_Path.name)
        ...
        self._gallery_image_label_dict[new_file_path.name] = [label, new_file_path, index]
    ...
    def gallery_image_highlight(self, image_name: str) -> None:
        ...
        :return:
        """
        self._gallery_image_label_axis_tuple = self.update_layout_and_get_coordinates()
        ...
        axis_x = self._gallery_image_label_axis_tuple[index]
    ...
    def update_layout_and_get_coordinates(self) -> list:
        ...
        # print('\033[46m' + f'{self._gallery_image_label_axis_tuple= }' + '\033[0m')
